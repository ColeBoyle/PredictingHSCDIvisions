...
ax2.bar(x_axis_2, threePhase.r_values_50bp, width=0.1, color="black", label="50 bp", zorder=3)
...
ax3.bar(x_axis_3, twoPhase.r_values_50bp, width=0.1, color="black", label="50 bp", zorder=3)
...
ax4.plot(threePhase.breakpoints, threePhase.div_50bp, color="black", linewidth=1.5)
...
ax5.plot(twoPhase.breakpoints, twoPhase.div_50bp, color="black", linewidth=1.5)
